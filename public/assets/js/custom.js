var Samar = (function () {
        ...
        $(".scroll")
            ...
            .on("click", function (event) {
                ...
                if (this.hash !== "") {
                    ...
                    $("html, body").animate({ scrollTop: scrollTopPosition }, 800, function () {});
                }
            });
        $("body").scrollspy({ target: ".navbar", offset: headerHeight + 2 });
    };
        ...
        jQuery(window).on("scroll", function () {
            if (jQuery(".sticky-header").length > 0) {
                ...
                if ($(window).scrollTop() > menu.offset().top) {
                    ...
                    $(".site-header .container > .logo-header .logo").attr("src", "images/logo.html");
                    $(".site-header .container > .logo-header .logo-2").attr("src", "images/logo-2.html");
                    $(".site-header .container > .logo-header .logo-3").attr("src", "images/logo-3.html");
                } else {
                    menu.removeClass("is-fixed");
                    $(".site-header .container > .logo-header .logo, .site-header .container > .logo-header .logo-2, .site-header .container > .logo-header .logo-3").attr("src", "images/logo-white.html");
                }
            }
        });
    };
    var masonryBox = function () {
        ...
        if (jQuery("#masonry, .masonry").length > 0) {
            ...
            if (jQuery(".card-container").length > 0) {
                ...
                self.imagesLoaded(function () {
                    filter: filterValue, self.masonry({ gutter: gutter, columnWidth: columnWidthValue, isAnimated: true, itemSelector: ".card-container" });
                });
            }
        }
        if (jQuery(".filters").length) {
            ...
            jQuery(".filters").on("click", "li", function () {
                ...
                self.isotope({ filter: filterValue, masonry: { gutter: gutter, columnWidth: columnWidthValue, isAnimated: true, itemSelector: ".card-container" } });
            });
        }
    };
    ...
    var wow_animation = function () {
        if ($(".wow").length > 0) {
            var wow = new WOW({ boxClass: "wow", animateClass: "animated", offset: 0, mobile: false });
            wow.init();
        }
    };
    ...
    var lightGallery = function () {
        if ($("#lightgallery, .lightgallery").length > 0) {
            $("#lightgallery, .lightgallery").lightGallery({ selector: ".lightimg", loop: true, thumbnail: true, exThumbImage: "data-exthumbimage" });
        }
    };
    var handleBootstrapTouchSpin = function () {
        if (jQuery("input[name='demo_vertical2']").length) {
            jQuery("input[name='demo_vertical2']").TouchSpin({ verticalbuttons: true, verticalupclass: "ti-plus", verticaldownclass: "ti-minus" });
        }
    };
